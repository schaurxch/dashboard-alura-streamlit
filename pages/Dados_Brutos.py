...
st.sidebar.title('Filtros das Linhas')
st.sidebar.markdown('Utilize os filtros abaixo para filtrar as linhas da tabela.')
...
with col1:
    nome_arquivo = st.text_input('', label_visibility='collapsed', placeholder='Nome do arquivo', value='dados_brutos')
